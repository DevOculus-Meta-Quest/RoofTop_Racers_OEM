...
export declare class Entity {
    ...
    /**
     * Makes an Entity visible or hidden for a set of players within a world instance.
     * @param players - An array of Player objects to set the visibility mode for. An
     * empty array includes all players in the world instance.
     * @param mode - true to make the entity visible to the specified players; false to hide
     * the entity from those players.
     *
     * @remarks
